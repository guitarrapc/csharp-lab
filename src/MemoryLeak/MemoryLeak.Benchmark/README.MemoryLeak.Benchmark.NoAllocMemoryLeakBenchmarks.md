...
| RentReturn        | ShortRun-.NET 9.0 | .NET 9.0 | 1      |  19.36 ns |  0.420 ns | 0.023 ns |  19.34 ns |  19.39 ns |         - |
| AllocateArrayPool | ShortRun-.NET 9.0 | .NET 9.0 | 1      |  83.10 ns |  2.772 ns | 0.152 ns |  82.98 ns |  83.27 ns |         - |
| **RentReturn**        | **ShortRun-.NET 8.0** | **.NET 8.0** | **10**     |        **NA** |        **NA** |       **NA** |        **NA** |        **NA** |        **NA** |
| AllocateArrayPool | ShortRun-.NET 8.0 | .NET 8.0 | 10     |        NA |        NA |       NA |        NA |        NA |        NA |
| RentReturn        | ShortRun-.NET 9.0 | .NET 9.0 | 10     | 412.74 ns | 14.992 ns | 0.822 ns | 412.12 ns | 413.67 ns |         - |
| AllocateArrayPool | ShortRun-.NET 9.0 | .NET 9.0 | 10     | 666.74 ns | 56.249 ns | 3.083 ns | 664.73 ns | 670.29 ns |         - |
